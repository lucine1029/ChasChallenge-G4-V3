...
//         <span className='kebab' onClick={closeModal}>
//         <GoKebabHorizontal />
...
//             <p className='card-text' > Längd: 78 cm {childData.measurements}</p>
//               Allergier:{' '}
        ...
        <div className='card'>
          <div className='card-body'>
            ...
            <p className='card-text allergies'>
              ...
              Allergier: {childData.allergies.map((allergy, allergyIndex) => (
                <span key={allergyIndex}>
                  {allergy.name}
                  {allergyIndex < childData.allergies.length - 1 ? ', ' : ''}
                </span>
